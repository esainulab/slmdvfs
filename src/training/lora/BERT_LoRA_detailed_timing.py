#!/usr/bin/env python3
"""
BERT LoRA with Detailed Per-Step Timing + Event Logging
...
def main():
    ...
    print("=" * 80)
    print(f"BERT LoRA - Detailed Timing - {args.dataset.upper()}")
    print("=" * 80)
    ...
    # Apply LoRA
    logger.log_event("lora_application_start", "Applying LoRA")
    ...
    logger.log_event("lora_application_end", "LoRA applied")
