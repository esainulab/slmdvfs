#!/bin/bash
# GPU Frequency Capping Experiment - QNLI, N=256, BERT-large (340M)
# Tests bert-large-uncased at BASELINE + all 11 GPU frequencies
#
...
FREQS=(612 714 816 918 1020 1122 1300)
MODEL_NAME="bert-large-uncased"
BATCH_SIZE=32
MODEL_LABEL="BERT-large"
...
OUTPUT_BASE="${SCRIPT_DIR}/runs/qnli_gpu_freq_bert_large"
...
run_single() {
    ...
    local experiment_name="BERT_large_QNLI_${freq}"
...
run_experiments() {
    print_header "QNLI GPU FREQUENCY EXPERIMENT — BERT-large (340M)"
...
QNLI GPU Frequency Experiment — BERT-large (340M)
================================================
Date: $(date)
Model: $MODEL_NAME
Dataset: $DATASET
