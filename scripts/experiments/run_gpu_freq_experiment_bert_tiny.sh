#!/bin/bash
# GPU Frequency Capping Experiment - QNLI, N=256, BERT-tiny (14M)
...
OUTPUT_BASE="${SCRIPT_DIR}/runs/qnli_gpu_freq_bert_tiny"
...
run_single() {
    ...
    local experiment_name="${MODEL_LABEL}_QNLI_${freq}"
...
run_experiments() {
    print_header "QNLI GPU FREQUENCY EXPERIMENT — BERT-tiny (14M)"
...
QNLI GPU Frequency Experiment — BERT-tiny (14M)
================================================
Date: $(date)
Model: $MODEL_NAME
Dataset: $DATASET
