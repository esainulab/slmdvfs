#!/usr/bin/env python3
"""
BERT Full Fine-Tuning with Event Logging
...
def main():
    ...
    print("=" * 80)
    print(f"BERT Full Fine-Tuning with Event Logging - {args.dataset.upper()}")
    print("=" * 80)
    ...
    logger.log_event("model_loading_end", "Model loaded and moved to device",
